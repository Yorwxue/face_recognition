...
if __name__ == "__main__":
    # demo
    # image_filename = '/media/clliao/9c88dfb2-c12d-48cc-b30b-eaffb0cbf545/face_recognition_dataset/face_database/葉佳龍/09.png'
    # face_detection(image_filename)

    # -------------------
    # update database
    face_vectors, face_source, _ = facenet.faceDB(db_name, img_path=known_img_path, update=True)

    # -------------------

    # output_json = list()
    #
    # for each_source in range(len(face_source)):
    #     name = face_source[each_source].split('/')[-2]
    #     vector = face_vectors[each_source]
